...
func SetFilter(instrs []linux.BPFInstruction) error {
	...
	// remain on the same thread. (For whatever reason,
	// SECCOMP_FILTER_FLAG_TSYNC doesn't require that other threads in the
	// thread group have invoked PR_SET_NO_NEW_PRIVS.)
